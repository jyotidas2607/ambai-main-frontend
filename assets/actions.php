 ...
 *
 * @package Starter Theme WordPress Theme
...
function starter_theme_scripts() {
	wp_enqueue_style( 'starter_theme-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'starter_theme-style', 'rtl', 'replace' );

	wp_enqueue_script( 'starter_theme-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
